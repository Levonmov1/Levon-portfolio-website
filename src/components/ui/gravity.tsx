...
const Gravity = forwardRef<GravityRef, GravityProps>(
  (
      ...
      (id: string, element: HTMLElement, props: MatterBodyProps) => {
        ...
        if (props.bodyType === "circle") {
          ...
          body = Bodies.rectangle(x, y, width, height, {
            ...(props.matterBodyOptions as Record<string, unknown>),
            angle: angle,
            render: {
              fillStyle: debug ? "#888888" : "#00000000",
              strokeStyle: debug ? "#333333" : "#00000000",
    ...
    const initializeRenderer = useCallback(() => {
      ...
      // Make the render canvas non-interactive so scroll events pass through
      render.current.canvas.style.pointerEvents = "none";

      // Attach mouse to the container div instead of the canvas
