...
export default function Navbar() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-30">
      <Dock className="z-50 pointer-events-auto relative h-14 p-2 w-fit mx-auto flex gap-1 sm:gap-2 border bg-card/90 backdrop-blur-3xl shadow-[0_0_10px_3px] shadow-primary/5">
        {/* Navigation icons */}
        ...
        {/* Mobile: single social button with popover — hidden on mobile, moved to hub */}
        <Separator
          orientation="vertical"
          className="h-2/3 m-auto w-px bg-border hidden"
        />
        <div ref={socialRef} className="relative hidden">
          <Tooltip>
            <TooltipTrigger asChild>
